...
function Intro(props: any) {
  return (
    <div
      className="flex flex-col justify-start items-start px-4 mt-16 md:px-10 md:mt-24 lg:pl-40 lg:max-w-5xl lg:mt-40"
      ref={props.refp}
    >
      ...
      <p className="text-start text-black font-light font-titleNorm mb-10 text-lg md:mb-16 md:text-xl lg:text-2xl lg:mb-24">
        ...
        turpis felis, laoreet non pellentesque eu, convallis eu elit. Curabitur
        eleifend, sapien a bibendum imperdiet, purus ante fringilla nunc, tempus
        ullamcorper turpis turpis sit amet mauris. Donec ullamcorper nunc ut
        ligula mollis dapibus. Nullam ut augue rhoncus, elementum diam et,
        blandit felis. Nulla id tortor id massa vehicula fringilla a vel mi. Sed
        mollis efficitur aliquet.
      </p>
